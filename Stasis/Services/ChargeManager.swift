...
enum CalibrationStage: String {
    ...
    var title: String {
        switch self {
        case .idle: IadenteL10n.t("空闲", "Idle")
        case .chargingToFull: IadenteL10n.t("校准：充电至 100%", "Calibration: Charging to 100%")
        case .dischargingToLow: IadenteL10n.t("校准：正在放电", "Calibration: Discharging")
        case .rechargingToFull: IadenteL10n.t("校准：重新充电至 100%", "Calibration: Recharging to 100%")
        case .holdingAtFull: IadenteL10n.t("校准：满电保持", "Calibration: Holding at Full")
        case .restoringLimit: IadenteL10n.t("校准：恢复充电上限", "Calibration: Restoring Charge Limit")
        }
    }
}
...
enum ChargeOperationStatus: Equatable {
    ...
    var title: String {
        switch self {
        case .monitoring: IadenteL10n.t("只读监测")
        case .charging: IadenteL10n.t("正在充电")
        case .paused: IadenteL10n.t("充电已暂停")
        case .sailing: IadenteL10n.t("巡航中")
        case .discharging(let target):
            IadenteL10n.t("正在放电至 \(target)%", "Discharging to \(target)%")
        case .topUp: IadenteL10n.t("临时充至 100%")
        case .heatProtection: IadenteL10n.t("高温保护")
        case .sleeping: IadenteL10n.t("睡眠保护")
...
class ChargeManager {
    ...
    var controlError: String? {
        ...
        return IadenteL10n.controlError(rawError)
    }
    var operationStatusTitle: String {
        controlError == nil ? operationStatus.title : IadenteL10n.t("充电控制未生效")
    }
    ...
    private func evaluate(controlState: BatteryControlState) {
        guard !IadenteRuntime.isUIPreview else {
        ...
        if isSystemSleeping && Defaults[.stopChargingWhileSleeping] {
            ...
            chargingStateReason = IadenteL10n.t(
                "Mac 睡眠时已暂停充电",
    ...
    private func advanceCalibrationIfNeeded(batteryPercentage: Int) {
        if topUpActive && batteryPercentage >= 100 {
            ...
            sendWorkflowNotification(
                title: IadenteL10n.t("临时补电完成", "Top-Up Complete"),
                body: IadenteL10n.t(
        ...
        case .restoringLimit
            ...
            sendWorkflowNotification(
                title: IadenteL10n.t("电池校准完成", "Battery Calibration Complete"),
                body: IadenteL10n.t(
    ...
    private func setAdapter(enabled: Bool) {
        ...
        Task {
            do {
                ...
                adapterControlError = IadenteL10n.t(
    ...
    private func updateSleepAssertion(shouldPreventSleep: Bool) {
        ...
        if shouldPreventSleep && !assertionActive {
            let result = IOPMAssertionCreateWithName(
                ...
                "iadente: charging toward the configured limit" as CFString,
                &sleepAssertionID
            )
    ...
    func checkControlService() {
        ...
        Task {
            do {
                ...
                serviceControlError = IadenteL10n.t(
