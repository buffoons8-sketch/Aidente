...
enum ScheduleActionKind: String, Codable, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .setChargeLimit: IadenteL10n.t("设置充电上限")
        case .startCalibration: IadenteL10n.t("开始电池校准")
        case .topUp: IadenteL10n.t("临时充至 100%")
        case .pauseCharging: IadenteL10n.t("暂停充电")
        case .dischargeTo: IadenteL10n.t("放电至")
        }
    }
...
enum ScheduleRepeatRule: String, Codable, CaseIterable, Identifiable {
    ...
    var title: String {
        switch self {
        case .never: IadenteL10n.t("仅一次")
        case .daily: IadenteL10n.t("每天")
        case .weekdays: IadenteL10n.t("工作日")
        case .weekly: IadenteL10n.t("每周")
        case .biweekly: IadenteL10n.t("每两周")
        case .monthly: IadenteL10n.t("每月")
        }
    }
}
